...
const i18n = {
    ...
    "inst-p": {
        ...
        "es": "Se te presentará una serie de enunciados. Para cada uno, haz click en el botón con tu opinión en él."
    },
    "inst-gotit": {
        "en": "Got it!",
        "de": "Verstanden",
    ...
    "result-h2-match": {
        ...
        "es": "Coincidencia más cercana: <span class='weight-300' id='ideology-label'> </span>"
    },
    "result-h2-next-matches": {
        "en": "Next closest matches",
        "de": "Nächst höchste Überstimmungen",
        "es": "Siguientes coincidencias más cercanas"
    },
    "next-matches-percent": {
        ...
        "es": "Con tu coincidencia más cercana siendo un 100% y la más lejana un 0%, aquí está lo más que te acercas a las otras ideologías."
    },
    "result-h2-score": {
        "en": "I don't like my scores!",
        "de": "Ich mag meine Ergebnisse nicht",
        "es": "¡No me gustan mis puntajes!"
    },
    "result-issues": {
        ...
        "es": "Por favor, recordar que no se supone que consigas un puntaje del 100% en cualquiera de las categorías. El punto de la encuesta es desafiar tus puntos de vista. Si tienes alguna sugerencia o crítica constructiva, por favor llena este <a href='https://forms.gle/6WZYMb5GXkkDLhxr5'>formulario</a> o abre un issue (reporte) en la <a href='https://github.com/LeftValues/leftvalues.github.io'>Página de GitHub</a>."
    },
    "result-a-label": {
    ...
    "result-b-label": {
        ...
        "es": ["Extremadamente científico", "Muy científico", "Científico", "Neutral", "Utópico", "Muy utópico", "Extremadamente utópico"]
    },
    "result-c-label": {
        ...
        "es": ["Extremadamente centralista", "Muy centralista", "Centralista", "Neutral", "Descentralista", "Muy descentralista", "Extremadamente descentralista"]
    },
    "result-d-label": {
        ...
        "es": ["Extremedamente internacionalista", "Muy internacionalista", "Internacionalista", "Neutral", "Nacionalista", "Muy nacionalista", "Extremadamente nacionalista"]
    },
    "result-e-label": {
        ...
        "es": ["Extremadamente partidista", "Muy partidista", "Partidista", "Neutral", "Unionista", "Muy unionista", "Extremadamente unionista"]
    },
    "result-f-label": {
    ...
    "index-b-start": {
        ...
        "es": "¡Haz click aquí para empezar!"
    },
    "index-h2-whatis" : {
    ...
    "index-p-answer": {
        ...
        "es": "LeftValues es una encuesta política de izquierda, inspirada y basada en la encuesta <a href='https://8values.github.io/'>8values</a>, que busca identificar tu posición en el espectro político de izquierda. " + 
            "Si no eres de izquierda, esta encuesta obviamente no está hecha para ti. Se te presentará un enunciado, y tú debes responder con tu opinión sobre éste, desde <b>Muy de acuerdo</b> a <b>Muy en desacuerdo</b>, con cada respuesta afectando ligeramente tu puntaje. Las preguntas para cada eje están ordenadas, en vez de repartidas. Al terminar la encuesta, tus respuestas serán comparadas con el máximo posible para cada valor, dándote un porcentaje. ¡Responde de forma honesta!<br/><br/>" +
    ...
    "index-sixaxes": {
        ...
        "es": "Actualmente hay seis ejes, y cada uno tiene dos valores opuestos. Éstos son:"
    },
    "index-rev-desc": {
        ...
        "Aquellos con un mayor puntaje revolucionario tienden a apoyar un derrocamiento de forma radical y rápida del sistema capitalista a través de un levantamiento en masa. Aquellos con un mayor puntaje reformista tienen a favorecer cambios gradiales en sistemas capitalistas, como la democracia liberal, con el objetivo final de alcanzar el socialismo."
    },
    "index-sci-desc": {
        ...
        "Aquellos con un mayor puntaje científico tiended a apoyar o simpatizar con el análisis Marxista de la sociedad, según el materialismo dialéctico. Aquellos con un mayor puntaje utópico tienden a seguir un análisis idealista de la sociedad y a rechazar enfoques materialistas."
    },
    "index-cent-desc": {
        ...
        "es": "<b style='color:#560000;'>Centralista</b> <b>vs.</b> <b style='color:#000000;'>Descentralista</b><br/>" + 
        "Aquellos con un mayor puntaje centralista tienden a apoyar una estructura económica basada en planificación nacional centralizada. Aquellos con un mayor puntaje descentralista tienden a apoyar una estructura económica basada en planificación descentralizada, usualmente en una escala local."
    },
    "index-int-desc": {
        ...
        "Aquellos con un mayor puntaje internacional tienden a apoyar la formación de un movimiento socialista internacional, usualmente con el objetivo final de abolir el concepto de nación. Aquellos con un mayor puntaje nacional tienden a priorizar la construcción del socialismo dentro de los límites nacionales y a rechazar la idea de una república socialista global."
    },
    "index-party-desc": {
        ...
        "Aquellos con un mayor puntaje partidista tienden a favorecer el uso de partidos políticos como la base del movimiento socialista. Aquellos con un mayor puntaje unionista tienden a favorecer el uso de sindicatos y otros modos de organización de masas como la base del movimiento socialista. Ser pro-partido no necesariamente significa oponerse a las uniones y viceversa, se trata de tu preferencia."
    },
    "index-prod-desc": {
        ...
        "Aquellos con un mayor puntaje productivista tienden a priorizar la producción industral y autosustentación por sobre fines ecológicos. Aquellos con un mayor puntaje naturalista tienden a apoyar una economía orientada al ambiente, con protecciones ecológicas estrictas."
    },
    "index-cons-desc": {
        ...
        "es": "<b style='color:#27577A;'>Conservativo</b> <b>vs.</b> <b style='color:#C4A717;'>Progresista</b><br/>" +
        "Aquellos con un mayor puntaje conservativo tienden a favorecer políticas y creencias socialmente conservadoras. Aquellos con un mayor puntaje progresista tiended a apoyar políticas y creencias socialmente progresistas.",
    },
    "index-h2-closest": {
        "en": "What does \"Closest Match\" mean in the results?",
        "de": "Was bedeutet \"Nächste Übereinstimmung\" in den Ergebnissen?",
        "es": "¿Qué significa \"Coincidencia más cercana\" en los resultados?"
    },
    "index-p-similar": {
        ...
        "es": "De forma similar a 8values, la encuesta va a intentar relacionarte con una ideología específica de izquierda. Por ahora hay doce ideologías posibles, y más vendrán en el futuro. Esto es un trabajo en progreso y puede que no funcione correctamente. Las sugerencias son muy bienvenidas. Las ideologías disponibles son: Marxismo-Leninismo, Marxismo Ortodoxo, Marxismo Ecológico, Marxismo Centrista, Comunismo Consejista, Comunismo de Izquierda, Anarcocomunismo, Anarquismo Verde, Anarquismo de Mercado, Socialismo Utópico, Socialismo Democrático y Socialdemocracia"
    },
    "index-h2-scores": {
        "en": "I don't like my scores!",
        "de": "Ich mag meine Ergebnisse nicht",
    ...
    "index-p-scores": {
        "en": "Please remember that you are not intended to get a 100% score in any of the categories. The point of the quiz is to challenge your views. If you have any suggestions or constructive criticism please fill out this <a href='https://forms.gle/6WZYMb5GXkkDLhxr5'>short form</a> or open an issue on the <a href='https://github.com/LeftValues/leftvalues.github.io'>GitHub Page</a>.",
        "de": "Bitte denken Sie daran, dass Sie in keiner der Kategorien eine 100%-ige Punktzahl erzielen möchten. Ziel des Quiz ist es, Ihre Ansichten zu hinterfragen. Wenn Sie Anregungen oder konstruktive Kritik haben, füllen Sie bitte dieses <a href='https://forms.gle/6WZYMb5GXkkDLhxr5'>Kurzformular</a> aus oder öffnen Sie ein Problem auf der <a href='https://github.com/LeftValues/leftvalues.github.io'>GitHub-Seite</a>.",
        "es": "Por favor, recuerda que no se supone que consigas un puntaje del 100% en cualquiera de las categorías. El punto de la encuesta es desafiar tus puntos de vista. Si tienes alguna sugerencia o crítica constructiva, por favor llena este <a href='https://forms.gle/6WZYMb5GXkkDLhxr5'>formulario</a> o abre un issue (reporte) en la <a href='https://github.com/LeftValues/leftvalues.github.io'>Página de GitHub</a>."
    },
    "index-h2-tracked": {
    ...
    "index-p-tracked": {
        ...
        "es": "LeftValues utiliza rastreo básico para tener una idea de la cantidad de visitantes. No se recolecta información personal y tus respuestas no son guardadas. Si no me crees, tenemos código abierto y disponible a la vista de todos. Con fines de transparencia, los datos recolectados durante la primera semana de lanzamiento se pueden ver en este <a href='https://docs.google.com/document/d/1pcnZdMkEmGXgLMS8izvqd_JEcgjuFgUnfqCRO32q2go/edit?usp=sharing'>Documento de Google</a>."
    }
}
